...
const socket = io("https://13.235.82.182:8080/", {
...
const Chat = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get("https://13.235.82.182:8080//api/users", {
    ...
    const fetchMessages = async () => {
      try {
        const response = await axios.get("https://13.235.82.182:8080/api/messages", {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        });
